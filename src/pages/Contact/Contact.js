...
const Contact = () => {
  ...
  return (
    <div className="max-w-container mx-auto px-4 sm:px-6 lg:px-8">
      ...
      {successMsg ? (
        <p className="pb-20 max-w-md font-medium text-green-500">
          {successMsg}
        </p>
      ) : (
        <form className="pb-20">
          ...
          <div className="w-full max-w-lg h-auto py-6 flex flex-col gap-6">
            <div>
              <p className="text-sm md:text-base font-titleFont font-semibold px-2">
                Name
              </p>
              <input
                onChange={handleName}
